...
void Player::draw(unsigned int shaderProgram, const glm::mat4& view, const glm::mat4& projection, float serverTime, const Camera& camera) {
    glUseProgram(shaderProgram);

    glm::mat4 model = glm::translate(glm::mat4(1.0f), glm::vec3(camera.Position.x, 1.0f, camera.Position.z));
