...
# Source files
MAIN_SRC = $(INCLUDE_DIR)/main.cpp $(SRC_DIR)/text_renderer.cpp $(SRC_DIR)/camera.cpp $(SRC_DIR)/input_handler.cpp $(SRC_DIR)/cube.cpp $(SRC_DIR)/player.cpp $(SRC_DIR)/player2.cpp $(SRC_DIR)/chessboard.cpp
